...
import { NavLink } from 'react-router-dom';
import { useAuth0 } from '@auth0/auth0-react';
import { removeItem, clearCart, setDecrease, setIncrease, cartTotalItem, cartTotalPrice } from '../store/Slices/CartSlice';
...
function Cart() {
  ...
  // Calculate total items and total price when cart updates
  React.useEffect(() => {
    ...
    <div className='flex flex-col min-h-screen'>
      <div className='flex-grow'>
        ...
        <div className="flex justify-between mx-10">
          ...
          <button onClick={() => dispatch(clearCart())} className="bg-fuchsia-800 text-white px-4 py-2 rounded-lg">
            Clear Cart
          </button>
        </div>
        <div className="flex justify-end mx-10 mt-4">
